...
- 0.2
  - [0.2.11](#0211-account-security-bulk-crafting-chest-opening)
  - [0.2.10](#0210-jupiter-swap)
  - [0.2.9](#029-supplies-display)
  - [0.2.8](#028-marketplace-listings-improvements)
  - [0.2.7](#027-sso-steam-support-form)
  - [0.2.6](#026-marketplace)
  - [0.2.5](#025-orb-digger-account-deletion-and-migration-updates)
  - [0.2.4](#024-wheel-update-and-bridges)
...
## 0.2.11 Account security, bulk crafting, chest opening
...
- **Account**
  - Added an OTP option when logging in.
  - Added an option to choose when a session expires.
- **Crafting**
  - Added an option to bulk Power Up and Awaken up to 20 assets.
- **Chests**
  - Added an option to open a chest directly on the Portal.
- **Hepta Rush**
  - Added a mini-game, "Hepta Rush", initially planned for a marketing campaign.
  - Complete quests to earn up to 36,000 Trisel per day (multiplied by your EM).
...
- **Jupiter Swap**
  - Added the possibility to swap all CTA-related tokens, SOL, and USDC directly on the Portal through Jupiter.

### Improvements

- **Marketplace**
  - Allow users to bulk list, unlist or buy up to 20 assets with a single signature.

## 0.2.9 Supplies display
...
- **Assets**
  - Supplies of all NFT types have been added.

## 0.2.8 Marketplace listings improvements
...
- **Marketplace**
  - Users can now access their listings through a dedicated tab on the market page.
  - Users can now set a price from the current floor price when listing.
- **Assets**
  - The Activity tab is now available on the details view of an asset.

## 0.2.7 SSO Steam, Support form
...
- **Steam**
  - Users can now link their Steam account.
- **Support**
  - Users can now contact support directly from the Portal.
  - Available at: <https://portal.crosstheages.com/support>
...
- **Marketplace**
  - Users can now list, unlist, and buy assets on the marketplace using CTA tokens.
